...
<main class="py-6 px-4 md:px-8">
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-3xl font-bold text-gray-800 tracking-tight">Tambah Angkatan</h2>
                <p class="text-base text-gray-500 mt-1">Buat angkatan baru untuk sistem</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div class="flex items-center">
                ...
                <div>
                    <h5 class="text-lg font-bold text-gray-800">Form Tambah Angkatan</h5>
                    <p class="text-sm text-gray-600 mt-1">Lengkapi informasi angkatan yang akan ditambahkan</p>
                </div>
            </div>
        </div>
            ...
            <form action="{{ route('years.store') }}" method="POST" id="yearForm">
                ...
                <div class="mt-8 flex flex-col sm:flex-row gap-3 sm:justify-end">
                    ...
                    <button type="submit" class="w-full sm:w-auto bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200 inline-flex items-center justify-center shadow-sm">
                        <i class="fas fa-save mr-2"></i>Simpan Angkatan
                    </button>
                </div>
            </form>
        </div>
