            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4">
                        <h2 class="text-lg font-semibold text-white">Informasi Tahun Ajaran</h2>
                    </div>
                    <div class="p-6 space-y-4">
                        <div>
                            <label class="text-xs font-semibold text-gray-500 uppercase tracking-wider">Nama Tahun Ajaran</label>
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Tahun ajaran ini belum memiliki semester yang terdaftar.</p>
                        </div>
                        @endforelse
                    </div>
                </div>
