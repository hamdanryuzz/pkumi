...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        @if(session('error'))
            <div class="mb-6 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-md" role="alert">
                <div class="flex">
                    <div class="flex-shrink-0">
        ...
        <div class="bg-white shadow-sm rounded-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Total: {{ $courses->count() }} mata kuliah
                </p>
            </div>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan mata kuliah baru.</p>
                    <div class="mt-6">
                        <a href="{{ route('courses.create') }}" 
