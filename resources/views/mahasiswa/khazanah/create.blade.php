...
<div class="bg-white rounded-xl shadow-sm w-full max-w-5xl p-8 md:p-10 lg:p-12">
    ...
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-800">Submit Khazanah</h1>
        <p class="text-sm text-gray-500 mt-1">Kirimkan artikel khazanah kamu untuk di-review oleh admin.</p>
    </div>

    <form id="khazanah-form" method="POST" action="{{-- route('mahasiswa.khazanah.store') --}}" enctype="multipart/form-data" class="space-y-6">
        @csrf
        
        <div>
            <label for="judul" class="block text-sm font-medium text-gray-700">Judul Khazanah</label>
        ...
        <div>
            <label for="ringkasan" class="block text-sm font-medium text-gray-700">Ringkasan Khazanah</label>
        ...
        <div>
            <label for="tags" class="block text-sm font-medium text-gray-700">Tags Khazanah</label>
            <input type="text" id="tags" name="tags" placeholder="Contoh: islam, sejarah, tokoh (pisahkan dengan koma)"
                   class="mt-1 block w-full px-4 py-3 text-gray-700 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-primary focus:border-transparent">
        </div>

        <div>
            <label for="konten" class="block text-sm font-medium text-gray-700">Konten Khazanah</label>
