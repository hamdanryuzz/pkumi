...
@section('title', 'Tambah Semester - Sistem Penilaian PKUMI')
...
<main class="py-6 px-4 md:px-8">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-3xl font-bold text-gray-800 tracking-tight">Tambah Semester Baru</h2>
                <p class="text-base text-gray-500 mt-1">Buat Semester baru dengan pengaturan masa pendaftaran</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
            ...
            <p class="text-sm text-gray-600 mt-1">Lengkapi semua informasi Semester</p>
        </div>

        <form action="{{ route('semester.store') }}" method="POST" class="p-6">
            @csrf
